...
prop.table(Langstable <- table(Clusters$Language,Clusters$ClusterToFour),1)[c(2,3,6),] # within language cluster proportion
prop.table(Langstable <- table(Clusters$Language,Clusters$ClusterToFour),2)[c(2,3,6),] # within cluster language proportion
prop.table(Langstable <- table(Clusters$Sex,Clusters$ClusterToFour),1) # within language cluster proportion
prop.table(Langstable <- table(Clusters$Sex,Clusters$ClusterToFour),2) # within cluster language proportion
```
