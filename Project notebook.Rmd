...
names(MasterData) <- c("ID","Sex","Language","Final_grade","IU","Per_correct","Per_aware","Timw_hm","Time_pron","Time_LS","Per_correct_hw","Per_complete_LS")
...
ggplot(MasterData, aes(Language,Per_correct))+ geom_point() + stat_sum(aes(group = 1))

#Linguistic Background & Incorrect, Aware
ggplot(MasterData, aes(Language,Per_aware))+ geom_point() + stat_sum(aes(group = 1))
